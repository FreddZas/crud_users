...
const FormUser = ({ 
  ...
  return (
    <div on onClick={handleCloseForm} className={`formuser-container ${closeForm && 'close-form'}`}>
        <form onClick={e => e.stopPropagation()} className="formuser" onSubmit={handleSubmit(submit)}>
            ...
            <div className="formuser__group">
                ...
                <input className="formuser__input" {...register('email')} type="text" id="email" placeholder= "abc@mail.com"/>
            </div>
            <div className="formuser__group">
